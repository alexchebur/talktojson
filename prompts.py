...
- Подробное правовое заключение по запросу пользователя с учетом предварительных рассуждений (не ссылайтесь на них в заключении)
### КОНТЕКСТ
**Запрос клиента:**
{user_query}
...
2. Сгенерируй 3 дополнительных уточняющих вопроса (начинай с "Вопросы: ")
...
3. Нарушать структуру правового заключения
