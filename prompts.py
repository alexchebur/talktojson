...
1. Четко сформулируй юридическую проблему
2. Сгенерируй 3 дополнительных уточняющих вопроса для поиска
3. Выдели 5 ключевых слов для полнотекстового поиска

### ТРЕБОВАНИЯ К ВЫВОДУ
- Верни ответ ТОЛЬКО в формате JSON
- Используй структуру: 
{{
  "problem_formulation": "четкая формулировка проблемы",
  "expanded_queries": ["вопрос1", "вопрос2", "вопрос3"],
  "expanded_keywords": ["ключ1", "ключ2", "ключ3", "ключ4", "ключ5"]
}}
...
### ЗАДАЧА
На основе запроса, сформулированной проблемы и найденной информации:
1. Проведи пошаговый юридический анализ
2. Подготовь проект заключения
...
- Структура ответа:
{{
  "reasoning": "подробная цепочка рассуждений",
  "opinion_draft": "проект заключения (не менее 10000 символов)"
}}
"""
